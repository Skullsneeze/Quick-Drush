...
##########################################
alias dr='drush'
alias dr_en='drush en $1 -y'
alias dr_dis='drush dis $1 -y'
alias dr_cca='drush cc all'
alias dr_lft='drush features'
alias dr_encof='drush en coffee -y'
alias dr_endif='drush en diff -y'
alias dr_enfui='drush en field_ui -y'
